...
namespace RogueProject
{
    partial class DungeonMain
    {
        ...
        private Dictionary<char, Rectangle> tileMap = new()
        {
            ...
            { CommonData.MapCharacters["CornerNorthWest"], new Rectangle(32, 48, 16, 16) },
            { CommonData.MapCharacters["CornerSouthEast"], new Rectangle(16, 48, 16, 16) },
            { CommonData.MapCharacters["CornerNorthEast"], new Rectangle(32, 48, 16, 16) },
            { CommonData.MapCharacters["CornerSouthWest"], new Rectangle(16, 48, 16, 16) },
            ...
            { CommonData.MapCharacters["Vertical"], new Rectangle(32, 48, 16, 16) },
